...
function modal() {
  ...
  more.addEventListener('click', function () {
    overlay.style.display = 'block';
    this.classList.add('more-splash'); // Отмена прокрутки страницы

    document.body.style.overflow = 'hidden';
  });
  close.addEventListener('click', function () {
    overlay.style.display = 'none';
    more.classList.remove('more-splash'); // Возвращаем прокрутку
...
function timer() {
  var deadline = '2020-05-13T15:00:00';
  ...
  function getTimeRemaining(endtime) {
    ...
    seconds = Math.floor(t / 1000 % 60),
        ...
        hours = Math.floor(t / (1000 * 60 * 60)); // Получаем дни, часы, минуты, секунды
    // seconds = Math.floor((t / 1000) % 60),
    // minutes = Math.floor((t / 1000 / 60) % 60),
...
window.addEventListener('DOMContentLoaded', function () {
  var calc = __webpack_require__(/*! ./parts/calc */ "./src/js/parts/calc.js"),
